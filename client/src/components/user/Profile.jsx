...
const Profile = () => {
  ...
  return (
    <div>
        ...
        <div className="flex flex-col space-y-4 max-w-2xl w-full p-6 ">
          <div className="flex flex-col space-y-3 ">
            ...
            <div className="flex py-6   relative">
              ...
              <div className=" absolute left-1/2 cursor-pointer" onClick={()=>setDialogOpen(true)}>
                <div className="w-1/2 rounded-full mx-auto  hover:bg-gray-100  duration-300 transition   ">
                  <FaUserEdit size={24} color="black" className="mx-auto" />
                </div>
                <p>Edit Profile</p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p>
                    Added{" "}
                    {new Date(
                      user?.updated_at.split("T").map((date) => date)[0]
          ...
          <div className="max-w-4xl w-full mx-auto  rounded-2xl py-4">
      ...
      {
        dialogOpen && (
          <UpdateProfileDialog open={dialogOpen} setOpen={setDialogOpen}/>
        )
      }
    </div>
  );
